...
#  exp_matrix <-  Matrix_norm
#  annotdf <- annot_4_plotting_pca
#  melteddf <-melted_Matrix_nacho_norm
#  label4title <- label
...
# The program starts
####
PCA_box_density_tsnes_plots <- function( result_dir, exp_matrix, annotdf, melteddf, label4title, myperplexity, group_4_tsnes  ){
